...
int main()
{
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TInstance> instance = new Turbo::Core::TInstance(&enable_layer, &enable_instance_extensions);
    ...
    Turbo::Core::TRefPtr<Turbo::Extension::TSwapchain> swapchain = new Turbo::Extension::TSwapchain(surface, max_image_count - 1, Turbo::Core::TFormatType::B8G8R8A8_SRGB, 1, Turbo::Core::TImageUsageBits::IMAGE_COLOR_ATTACHMENT | Turbo::Core::TImageUsageBits::IMAGE_TRANSFER_SRC | Turbo::Core::TImageUsageBits::IMAGE_TRANSFER_DST, true);
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TBuffer> scale_buffer = new Turbo::Core::TBuffer(device, 0, Turbo::Core::TBufferUsageBits::BUFFER_UNIFORM_BUFFER | Turbo::Core::TBufferUsageBits::BUFFER_TRANSFER_DST, Turbo::Core::TMemoryFlagsBits::HOST_ACCESS_SEQUENTIAL_WRITE, sizeof(float));
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TBuffer> dynamic_buffer = new Turbo::Core::TBuffer(device, 0, Turbo::Core::TBufferUsageBits::BUFFER_UNIFORM_BUFFER | Turbo::Core::TBufferUsageBits::BUFFER_TRANSFER_DST, Turbo::Core::TMemoryFlagsBits::HOST_ACCESS_SEQUENTIAL_WRITE, sizeof(float));
    scale_ptr = dynamic_buffer->Map();
    memcpy(scale_ptr, &scale, sizeof(scale));
    dynamic_buffer->Unmap();

    Turbo::Core::TRefPtr<Turbo::Core::TBuffer> vertex_buffer = new Turbo::Core::TBuffer(device, 0, Turbo::Core::TBufferUsageBits::BUFFER_VERTEX_BUFFER | Turbo::Core::TBufferUsageBits::BUFFER_TRANSFER_DST, Turbo::Core::TMemoryFlagsBits::HOST_ACCESS_SEQUENTIAL_WRITE, sizeof(VERTEX_DATA));
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TDescriptorPool> descriptor_pool = new Turbo::Core::TDescriptorPool(device, 100, descriptor_sizes);
    ...
    std::vector<Turbo::Core::TRefPtr<Turbo::Core::TBuffer>> buffers2;
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TPipelineDescriptorSet> dynamic_pipeline__descriptor_set = descriptor_pool->Allocate(pipeline->GetPipelineLayout());
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        case Turbo::Core::TResult::SUCCESS: {
            ...
            std::vector<Turbo::Core::TRefPtr<Turbo::Core::TSemaphore>> signal_semaphores;
