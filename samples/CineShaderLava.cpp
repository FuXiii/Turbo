...
const std::string MY_FRAG_SHADER_STR = "#version 450\n"
                                       ...
                                       "	for (int i = 0; i < 16; i++) {\n"
                                       "		float fi = float(i);\n"
                                       "		float time = my_push_constants.time * (fract(fi * 412.531 + 0.513) - 0.5) * 2.0;\n"
                                       "		d = opSmoothUnion(\n"
                                       ...
                                       "}\n"
                                       "void main() {\n"
                                       "  vec3 rayOri = vec3((uv - 0.5) * vec2(my_push_constants.resolutionX/my_push_constants.resolutionY, 1.0) * 6.0, 3.0);\n"
                                       ...
                                       "  vec3 col = (0.5 + 0.5 * cos((b + my_push_constants.time * 3.0) + uv.xyx * 2.0 + vec3(0,2,4))) * (0.85 + b * 0.35);\n"
                                       "  col *= exp( -depth * 0.15 );\n"
...
int main()
{
    ...
    pipeline_layout << *my_vertex_shader << *my_fragment_shader;
