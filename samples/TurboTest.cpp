...
int main()
{
    ...
    Turbo::Core::TBuffer *color_0_vertex_buffer = new Turbo::Core::TBuffer(device, 0, Turbo::Core::TBufferUsageBits::BUFFER_VERTEX_BUFFER | Turbo::Core::TBufferUsageBits::BUFFER_TRANSFER_DST, Turbo::Core::TMemoryFlagsBits::HOST_ACCESS_SEQUENTIAL_WRITE, sizeof(POSITION_COLOR_UV) * POSITION_COLOR_UV_DATA.size());
    ...
    Turbo::Core::TBuffer *color_1_vertex_buffer = new Turbo::Core::TBuffer(device, 0, Turbo::Core::TBufferUsageBits::BUFFER_VERTEX_BUFFER | Turbo::Core::TBufferUsageBits::BUFFER_TRANSFER_DST, Turbo::Core::TMemoryFlagsBits::HOST_ACCESS_SEQUENTIAL_WRITE, sizeof(POSITION_COLOR_UV) * POSITION_COLOR_UV_DATA.size());
    ...
    Turbo::Core::TBuffer *color_2_vertex_buffer = new Turbo::Core::TBuffer(device, 0, Turbo::Core::TBufferUsageBits::BUFFER_VERTEX_BUFFER | Turbo::Core::TBufferUsageBits::BUFFER_TRANSFER_DST, Turbo::Core::TMemoryFlagsBits::HOST_ACCESS_SEQUENTIAL_WRITE, sizeof(POSITION_COLOR_UV) * POSITION_COLOR_UV_DATA.size());
    ...
    Turbo::Core::TBuffer *color_3_vertex_buffer = new Turbo::Core::TBuffer(device, 0, Turbo::Core::TBufferUsageBits::BUFFER_VERTEX_BUFFER | Turbo::Core::TBufferUsageBits::BUFFER_TRANSFER_DST, Turbo::Core::TMemoryFlagsBits::HOST_ACCESS_SEQUENTIAL_WRITE, sizeof(POSITION_COLOR_UV) * POSITION_COLOR_UV_DATA.size());
    ...
    Turbo::Core::TBuffer *color_4_vertex_buffer = new Turbo::Core::TBuffer(device, 0, Turbo::Core::TBufferUsageBits::BUFFER_VERTEX_BUFFER | Turbo::Core::TBufferUsageBits::BUFFER_TRANSFER_DST, Turbo::Core::TMemoryFlagsBits::HOST_ACCESS_SEQUENTIAL_WRITE, sizeof(POSITION_COLOR_UV) * POSITION_COLOR_UV_DATA.size());
    ...
    delete color_0_vertex_buffer;
    delete color_1_vertex_buffer;
    delete color_2_vertex_buffer;
    delete color_3_vertex_buffer;
    delete color_4_vertex_buffer;
    delete value_buffer;
