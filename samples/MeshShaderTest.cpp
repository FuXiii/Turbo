...
int main()
{
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TMeshShader> mesh_shader = new Turbo::Core::TMeshShader(device, Turbo::Core::TShaderLanguage::GLSL, MESH_SHADER_STR);
    ...
    pipeline_layout << *mesh_shader << *fragment_shader;
    Turbo::Core::TRefPtr<Turbo::Core::TMeshShaderStage> mesh_shader_stage = new Turbo::Core::TMeshShaderStage(mesh_shader);
