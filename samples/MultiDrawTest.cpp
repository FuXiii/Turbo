...
int main()
{
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TBuffer> value_buffer1 = new Turbo::Core::TBuffer(device, 0, Turbo::Core::TBufferUsageBits::BUFFER_UNIFORM_BUFFER | Turbo::Core::TBufferUsageBits::BUFFER_TRANSFER_DST, Turbo::Core::TMemoryFlagsBits::HOST_ACCESS_SEQUENTIAL_WRITE, sizeof(float));
    ...
    std::vector<Turbo::Core::TRefPtr<Turbo::Core::TBuffer>> buffers1;
    ...
    sky_cube_pipeline_layout << *vertex_shader << *fragment_shader;
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TPipelineDescriptorSet> pipeline_descriptor_set1 = descriptor_pool->Allocate(pipeline->GetPipelineLayout());
