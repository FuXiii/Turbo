...
int main()
{
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TBuffer> instanced_position_offset_buffer = new Turbo::Core::TBuffer(device, 0, Turbo::Core::TBufferUsageBits::BUFFER_VERTEX_BUFFER | Turbo::Core::TBufferUsageBits::BUFFER_TRANSFER_DST, Turbo::Core::TMemoryFlagsBits::HOST_ACCESS_SEQUENTIAL_WRITE, sizeof(POSITION) * POSITION_OFFSET_data.size());
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TVertexShader> input_attachment_vertex_shader = new Turbo::Core::TVertexShader(device, Turbo::Core::TShaderLanguage::GLSL, INPUT_ATTACHMENT_VERT_SHADER_STR);
    Turbo::Core::TRefPtr<Turbo::Core::TFragmentShader> input_attachment_fragment_shader = new Turbo::Core::TFragmentShader(device, Turbo::Core::TShaderLanguage::GLSL, INPUT_ATTACHMENT_FRAG_SHADER_STR);

    Turbo::Core::TRefPtr<Turbo::Core::TVertexShader> sky_vertex_shader = new Turbo::Core::TVertexShader(device, Turbo::Core::TShaderLanguage::GLSL, SKY_VERT_SHADER_STR);
    Turbo::Core::TRefPtr<Turbo::Core::TFragmentShader> sky_fragment_shader = new Turbo::Core::TFragmentShader(device, Turbo::Core::TShaderLanguage::GLSL, SKY_FRAG_SHADER_STR);
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TGraphicsPipeline> pipeline = new Turbo::Core::TGraphicsPipeline(pipeline_layout, render_pass, 0, instance_draw_vertex_bindings, vertex_shader_stage, fragment_shader_stage, Turbo::Core::TTopologyType::TRIANGLE_LIST, false, false, false, Turbo::Core::TPolygonMode::FILL, Turbo::Core::TCullModeBits::MODE_BACK_BIT, Turbo::Core::TFrontFace::CLOCKWISE, false, 0, 0, 0, 1, false, Turbo::Core::TSampleCountBits::SAMPLE_1_BIT, true, true, Turbo::Core::TCompareOp::LESS_OR_EQUAL, false, false, Turbo::Core::TStencilOp::KEEP, Turbo::Core::TStencilOp::KEEP, Turbo::Core::TStencilOp::KEEP, Turbo::Core::TCompareOp::ALWAYS, 0, 0, 0, Turbo::Core::TStencilOp::KEEP, Turbo::Core::TStencilOp::KEEP, Turbo::Core::TStencilOp::KEEP, Turbo::Core::TCompareOp::ALWAYS, 0, 0, 0, 0, 0, false, Turbo::Core::TLogicOp::NO_OP, true, Turbo::Core::TBlendFactor::SRC_ALPHA, Turbo::Core::TBlendFactor::ONE_MINUS_SRC_ALPHA, Turbo::Core::TBlendOp::ADD, Turbo::Core::TBlendFactor::ONE_MINUS_SRC_ALPHA, Turbo::Core::TBlendFactor::ZERO, Turbo::Core::TBlendOp::ADD);

    Turbo::Core::TPipelineLayout::TLayout sky_cube_pipeline_layout;
    sky_cube_pipeline_layout << *sky_vertex_shader << *sky_fragment_shader;
    Turbo::Core::TRefPtr<Turbo::Core::TVertexShaderStage> sky_vertex_shader_stage = new Turbo::Core::TVertexShaderStage(sky_vertex_shader);
    Turbo::Core::TRefPtr<Turbo::Core::TFragmentShaderStage> sky_fragment_shader_stage = new Turbo::Core::TFragmentShaderStage(sky_fragment_shader);
    Turbo::Core::TRefPtr<Turbo::Core::TGraphicsPipeline> sky_cube_pipeline = new Turbo::Core::TGraphicsPipeline(sky_cube_pipeline_layout, render_pass, 0, vertex_bindings, sky_vertex_shader_stage, sky_fragment_shader_stage, Turbo::Core::TTopologyType::TRIANGLE_LIST, false, false, false, Turbo::Core::TPolygonMode::FILL, Turbo::Core::TCullModeBits::MODE_FRONT_BIT, Turbo::Core::TFrontFace::CLOCKWISE, false, 0, 0, 0, 1, false, Turbo::Core::TSampleCountBits::SAMPLE_1_BIT, false, false, Turbo::Core::TCompareOp::LESS_OR_EQUAL, false, false);

    Turbo::Core::TPipelineLayout::TLayout input_attachment_pipeline_layout;
    input_attachment_pipeline_layout << *input_attachment_vertex_shader << *input_attachment_fragment_shader;
    Turbo::Core::TRefPtr<Turbo::Core::TVertexShaderStage> input_attachment_vertex_shader_stage = new Turbo::Core::TVertexShaderStage(input_attachment_vertex_shader);
    Turbo::Core::TRefPtr<Turbo::Core::TFragmentShaderStage> input_attachment_fragment_shader_stage = new Turbo::Core::TFragmentShaderStage(input_attachment_fragment_shader);
    Turbo::Core::TRefPtr<Turbo::Core::TGraphicsPipeline> input_attachment_pipeline = new Turbo::Core::TGraphicsPipeline(input_attachment_pipeline_layout, render_pass, 1, vertex_bindings, input_attachment_vertex_shader_stage, input_attachment_fragment_shader_stage, Turbo::Core::TTopologyType::TRIANGLE_LIST, false, false, false, Turbo::Core::TPolygonMode::FILL, Turbo::Core::TCullModeBits::MODE_BACK_BIT, Turbo::Core::TFrontFace::CLOCKWISE, false, 0, 0, 0, 1, false, Turbo::Core::TSampleCountBits::SAMPLE_1_BIT, true, false, Turbo::Core::TCompareOp::LESS_OR_EQUAL);
