...
void Test4()
{
    ...
    */
    ...
    Turbo::Core::TRefPtr<Turbo::Extension::TSurface> surface = new Turbo::Extension::TSurface(context.GetDevice(), nullptr, vk_surface_khr);
            ...
            [&](const PresentPassData &data, const Turbo::FrameGraph::TResources &resources, void *_context) {
                ...
                if (_context != nullptr)
                {
                    ...
                    if (result == Turbo::Core::TResult::SUCCESS)
                    {
                        ...
                        Turbo::Core::TRefPtr<Turbo::Core::TCommandBuffer> cb = temp_context->AllocateCommandBuffer();
                        cb->Begin();
                        ...
                        case Turbo::Core::TResult::MISMATCH: {
                            Turbo::Core::TRefPtr<Turbo::Core::TDevice> device = temp_context->GetDevice();
                            device->WaitIdle();
