...
const std::string RAY_GENERATION_SHADER_STR = ReadTextFile(asset_root + "/shaders/RayTracingKHRTestForReflections_WithoutLimited.rgen");
const std::string MISS_SHADER_STR = ReadTextFile(asset_root + "/shaders/RayTracingKHRTestForReflections_WithoutLimited.rmiss");
const std::string SHADOW_MISS_SHADER_STR = ReadTextFile(asset_root + "/shaders/RayTracingKHRTestForReflectionsShadow_WithoutLimited.rmiss");
const std::string CLOSEST_HIT_SHADER_STR = ReadTextFile(asset_root + "/shaders/RayTracingKHRTestForReflections_WithoutLimited.rchit");
...
int main()
{
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TBuffer> sbt_buffer = nullptr;
    {
        ...
        ray_tracing_depth_push_constant_range.stageFlags = VkShaderStageFlagBits::VK_SHADER_STAGE_RAYGEN_BIT_KHR;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        case Turbo::Core::TResult::SUCCESS: {
...

            {
                ...
                ImGui::SliderInt("Ray Tracing Depth", &ray_tracing_depth, 0, 100);
            ...
            // ray tracing commands
            {
                ...
                device_driver->vkCmdPushConstants(vk_command_buffer, ray_tracing_pipeline_layout, VkShaderStageFlagBits::VK_SHADER_STAGE_RAYGEN_BIT_KHR, 0, sizeof(ray_tracing_depth), &ray_tracing_depth);
