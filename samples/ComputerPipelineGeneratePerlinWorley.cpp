...
// For generate Perlin-Worley noise 3D noise texture
...
int main()
{
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TImage> perlin_worly_noise_3d_image = new Turbo::Core::TImage(device, 0, Turbo::Core::TImageType::DIMENSION_3D, Turbo::Core::TFormatType::R8G8B8A8_UNORM, perlin_worly_noise_3d_image_width, perlin_worly_noise_3d_image_height, perlin_worly_noise_3d_image_depth, 1, 1, Turbo::Core::TSampleCountBits::SAMPLE_1_BIT, Turbo::Core::TImageTiling::OPTIMAL, Turbo::Core::TImageUsageBits::IMAGE_SAMPLED | Turbo::Core::TImageUsageBits::IMAGE_STORAGE, Turbo::Core::TMemoryFlagsBits::DEDICATED_MEMORY, Turbo::Core::TImageLayout::UNDEFINED);
    Turbo::Core::TRefPtr<Turbo::Core::TImageView> perlin_worly_noise_3d_image_view = new Turbo::Core::TImageView(perlin_worly_noise_3d_image, Turbo::Core::TImageViewType::IMAGE_VIEW_3D, perlin_worly_noise_3d_image->GetFormat(), Turbo::Core::TImageAspectBits::ASPECT_COLOR_BIT, 0, 1, 0, 1);
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TComputeShader> my_computer_shader = new Turbo::Core::TComputeShader(device, Turbo::Core::TShaderLanguage::GLSL, MY_COMPUTE_SHADER_STR);
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TComputeShaderStage> my_computer_shader_stage = new Turbo::Core::TComputeShaderStage(my_computer_shader);
    Turbo::Core::TRefPtr<Turbo::Core::TComputePipeline> compute_pipeline = new Turbo::Core::TComputePipeline(compute_pipeline_layout, my_computer_shader_stage);
    ...
    my_push_constants_data.coverage = 0.15;
