...
int main()
{
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TImage> compute_image = new Turbo::Core::TImage(device, 0, Turbo::Core::TImageType::DIMENSION_2D, Turbo::Core::TFormatType::R8G8B8A8_UNORM, compute_image_width, compute_image_height, 1, 1, 1, Turbo::Core::TSampleCountBits::SAMPLE_1_BIT, Turbo::Core::TImageTiling::OPTIMAL, Turbo::Core::TImageUsageBits::IMAGE_SAMPLED | Turbo::Core::TImageUsageBits::IMAGE_STORAGE, Turbo::Core::TMemoryFlagsBits::DEDICATED_MEMORY, Turbo::Core::TImageLayout::UNDEFINED);
    ...
    Turbo::Core::TRefPtr<Turbo::Core::TSampler> texture_sampler = new Turbo::Core::TSampler(device);
