...
const std::string COMPUTE_SHADER_STR = "#version 450 core\n"
...
const std::string FRAG_SHADER_STR = "#version 450 core\n"
                                    ...
                                    "void main() {\n"
                                    "   vec4 color =texture(sampler2D(myTexture, mySampler), uv, 0);\n"
...
int main()
{
    ...
    uint32_t compute_image_width = 512;
    uint32_t compute_image_height = 512;
    Turbo::Core::TImage *compute_image = new Turbo::Core::TImage(device, 0, Turbo::Core::TImageType::DIMENSION_2D, Turbo::Core::TFormatType::R8G8B8A8_UNORM, compute_image_width, compute_image_height, 1, 1, 1, Turbo::Core::TSampleCountBits::SAMPLE_1_BIT, Turbo::Core::TImageTiling::OPTIMAL, Turbo::Core::TImageUsageBits::IMAGE_SAMPLED | Turbo::Core::TImageUsageBits::IMAGE_STORAGE, Turbo::Core::TMemoryFlagsBits::DEDICATED_MEMORY, Turbo::Core::TImageLayout::UNDEFINED);
    Turbo::Core::TImageView *compute_image_view = new Turbo::Core::TImageView(compute_image, Turbo::Core::TImageViewType::IMAGE_VIEW_2D, compute_image->GetFormat(), Turbo::Core::TImageAspectBits::ASPECT_COLOR_BIT, 0, 1, 0, 1);

    Turbo::Core::TComputeShader *compute_shader = new Turbo::Core::TComputeShader(device, Turbo::Core::TShaderLanguage::GLSL, COMPUTE_SHADER_STR);
    ...
    Turbo::Core::TSampler *texture_sampler = new Turbo::Core::TSampler(device);

    std::vector<Turbo::Core::TSampler *> graphics_pipeline_samplers;
    graphics_pipeline_samplers.push_back(texture_sampler);
    ...
    graphics_pipeline_descriptor_set->BindData(0, 0, 0, buffers);
    graphics_pipeline_descriptor_set->BindData(0, 1, 0, graphics_pipeline_image_views);
    ...
    compute_pipeline_image_views.push_back(compute_image_view);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        case Turbo::Core::TResult::SUCCESS: {
            ...
            command_buffer->CmdTransformImageLayout(Turbo::Core::TPipelineStageBits::COMPUTE_SHADER_BIT, Turbo::Core::TPipelineStageBits::COMPUTE_SHADER_BIT, 0, Turbo::Core::TAccessBits::SHADER_WRITE_BIT, Turbo::Core::TImageLayout::UNDEFINED, Turbo::Core::TImageLayout::GENERAL, compute_image_view);

            // Compute Pipeline for compute compute_image
            command_buffer->CmdBindPipeline(compute_pipeline);
            command_buffer->CmdBindPipelineDescriptorSet(compute_pipeline_descriptor_set);
            command_buffer->CmdDispatch(compute_image_width, compute_image_height, 1);

            command_buffer->CmdTransformImageLayout(Turbo::Core::TPipelineStageBits::COMPUTE_SHADER_BIT, Turbo::Core::TPipelineStageBits::FRAGMENT_SHADER_BIT, Turbo::Core::TAccessBits::SHADER_WRITE_BIT, Turbo::Core::TAccessBits::SHADER_READ_BIT, Turbo::Core::TImageLayout::GENERAL, Turbo::Core::TImageLayout::SHADER_READ_ONLY_OPTIMAL, compute_image_view);

            // Full Viewport for Graphics Pipeline
            ...
            command_buffer->CmdTransformImageLayout(Turbo::Core::TPipelineStageBits::BOTTOM_OF_PIPE_BIT, Turbo::Core::TPipelineStageBits::BOTTOM_OF_PIPE_BIT, 0, 0, Turbo::Core::TImageLayout::SHADER_READ_ONLY_OPTIMAL, Turbo::Core::TImageLayout::GENERAL, compute_image_view);
