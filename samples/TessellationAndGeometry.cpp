...
const std::string VERT_SHADER_STR = ReadTextFile(asset_root + "/shaders/TessellationAndGeometry.vert");
const std::string TESC_SHADER_STR = ReadTextFile(asset_root + "/shaders/TessellationAndGeometry.tesc");
const std::string TESE_SHADER_STR = ReadTextFile(asset_root + "/shaders/TessellationAndGeometry.tese");
const std::string GEOM_SHADER_STR = ReadTextFile(asset_root + "/shaders/TessellationAndGeometry.geom");
const std::string FRAG_SHADER_STR = ReadTextFile(asset_root + "/shaders/TessellationAndGeometry.frag");
...
int main()
{
    ...
    layout << *vertex_shader << *tessellation_control_shader << *tessellation_evaluation_shader << *geometry_shader << *fragment_shader;

    Turbo::Core::TRefPtr<Turbo::Core::TVertexShaderStage> vertex_shader_stage = new Turbo::Core::TVertexShaderStage(vertex_shader);
    Turbo::Core::TRefPtr<Turbo::Core::TTessellationControlShaderStage> tessellation_control_shader_stage = new Turbo::Core::TTessellationControlShaderStage(tessellation_control_shader);
    Turbo::Core::TRefPtr<Turbo::Core::TTessellationEvaluationShaderStage> tessellation_evaluation_shader_stage = new Turbo::Core::TTessellationEvaluationShaderStage(tessellation_evaluation_shader);
