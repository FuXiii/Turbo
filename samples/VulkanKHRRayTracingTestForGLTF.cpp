...
struct BOTTOM_LEVEL_ACCELERATION_STRUCTUR
{
...
BOTTOM_LEVEL_ACCELERATION_STRUCTUR CreateBottomLevelAccelerationStructure(Turbo::Core::TDevice *device, Turbo::Core::TDeviceQueue *queue, MESH &mesh)
{
