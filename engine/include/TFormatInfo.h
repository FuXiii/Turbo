...
namespace Turbo
{
	namespace Core
	{
		...
		{
			//��VK_FORMAT_R64G64B64_SINTΪR+G+B���͡�(��Щ��ʽ����Alpha����)
			//��VK_FORMAT_D16_UNORMΪDepth����
			//��VK_FORMAT_D16_UNORM_S8_UINTΪDepth+stencil����
			UNDEFINED = 0x000,
			RED = 0x001,
			GREEN = 0x002,
			BLUE = 0x004,
		...
		typedef uint32_t TFormatContentTypeFlags;

		//���ڶ����ʽ����������
		typedef enum class TFormatDataType
		{
			//��VK_FORMAT_R8G8_UNORMΪunsigned normalized�������͡�R8_SINTΪsigned integer��������
			//����VK_FORMAT_R8_SRGBΪsRGB����
			UNDEFINED = 0,
			UNSIGNED_NORMALIZED,
			SIGNED_NORMALIZED,
			UNSIGNED_SCALED,
		...
		//���ڶ����ʽ�������
		typedef enum class TFormatFamily
		{
			UNDEFINED = 0,
			NORMAL,
			PACK,
		...
		public:
			...
			//TFormatFamily GetFormatFamilyType();//����formatType��ȡ��ʽ��

			//uint8_t GetRedBitCount();//����formatType��ȡR������λ��
			//uint8_t GetGreenBitCount();//����formatType��ȡG������λ��
			//uint8_t GetBlueBitCount();//����formatType��ȡB������λ��
			//uint8_t GetAlphaBitCount();//����formatType��ȡA������λ��
			//uint8_t GetDepthBitCount();//����formatType��ȡD������λ��
			//uint8_t GetStencilBitCount();//����formatType��ȡS������λ��
