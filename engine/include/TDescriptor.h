...
typedef enum class TShaderDataType
{
    ...
    DOUBLE,
    STRUCT,
    IMAGE,         // texture2d or Texture2D<T> :: VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE
    SAMPLED_IMAGE, // sampler2d :: VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER
    SAMPLER,       // sampler or samplerState :: VK_DESCRIPTOR_TYPE_SAMPLER
