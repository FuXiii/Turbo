...
{
    Turbo::Core::TDescriptor::TType descriptor_type = this->descriptorSetLayout->GetDescriptorType(binding);
    ...
    if (descriptor_type == Turbo::Core::TDescriptor::TType::STORAGE_BUFFER)
    {
