...
void Turbo::Core::TShader::TLayout::Merge(TPushConstants::TOffset offset, TPushConstants::TSize size, VkShaderStageFlags flags)
{
    this->pushConstants.Merge(offset, size, flags);
}
