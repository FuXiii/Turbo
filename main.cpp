...
void ImageSaveToPPM(const Turbo::Core::TRefPtr<Turbo::Core::TImage> &image, const Turbo::Core::TRefPtr<Turbo::Core::TCommandBufferPool> &commandBufferPool, const Turbo::Core::TRefPtr<Turbo::Core::TDeviceQueue> &deviceQueue, std::string name)
{
...
int main()
{
    ...
    Turbo::Core::TVertexShaderStage *sky_vertex_shader_stage = new Turbo::Core::TVertexShaderStage(sky_vertex_shader);
    Turbo::Core::TFragmentShaderStage *sky_fragment_shader_stage = new Turbo::Core::TFragmentShaderStage(sky_fragment_shader);
    ...
    input_attachment_pipeline_layout << *vertex_shader << *fragment_shader;
    Turbo::Core::TVertexShaderStage *input_attachment_vertex_shader_stage = new Turbo::Core::TVertexShaderStage(input_attachment_vertex_shader);
    Turbo::Core::TFragmentShaderStage *input_attachment_fragment_shader_stage = new Turbo::Core::TFragmentShaderStage(input_attachment_fragment_shader);
